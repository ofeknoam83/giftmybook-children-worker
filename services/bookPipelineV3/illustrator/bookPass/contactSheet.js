...
5. ENDING: the final spread lands visually (warmth/resolution, not an arbitrary stop).${direction.paletteArc ? `
6. WORLD COHERENCE (2026-07-28 audit, book 4c8daf08: one spread was a warm-tan temple interior in an otherwise cool blue-purple alien-night book, and a landmark returned later as a structurally different object): the whole book must read as ONE world following the planned palette arc — act 1: ${direction.paletteArc.act1 || 'n/a'}; act 2: ${direction.paletteArc.act2 || 'n/a'}; act 3: ${direction.paletteArc.act3 || 'n/a'}. Flag any spread whose palette or environment design contradicts the arc and its neighboring spreads (reads as pasted in from a different book), and any distinctive landmark that returns later as a fundamentally different structure. These world-coherence flags are ADVISORY — severity "minor" — unless the spread also breaks the locked rendering style (class 6).` : ''}
