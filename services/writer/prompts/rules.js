...
const RULES_BY_TIER = {
  'young-picture': {
    ...
    structure: [
      ...
      'INVENT THE ARC: the shape of the story is yours to chart spread by spread. There is NO prescribed Scene A / Scene B / Scene C / Scene D. There is NO mandatory "home → journey → peak → heading home" template. Let the child, the theme, and the anecdotes dictate the shape. One story might be entirely at a splash pad. Another might wander through three different places. Another might never leave a garden. What you owe the reader: a real beginning that hooks, a middle with tension and surprise, and a warm concrete resolution. Everything else is on you.',
      'OPENING LOCATION (HARD RULE): Spread 1 must be in a non-home, specific outdoor or public setting. "Waking up in bed", "at the kitchen table", "on the living-room rug", "in the playroom" are SHIP-BLOCKERS. Examples of acceptable openings: a splash pad, a park bench, the top of a slide, a tidepool, a meadow, a market stall, a bakery queue, a garden gate, the foot of a big tree. Pick something you could PHOTOGRAPH.',
    ...
    antiAI: [
      ...
      'NEVER open the story at home (HARD RULE): no waking up in bed, no morning at the kitchen table, no sitting on the living-room rug for spread 1. Spread 1 opens in a non-home, specific outdoor or public setting (park, splash pad, meadow, beach, bakery, garden gate, market, forest path, bus stop). Home may appear only if the story organically returns there near the end.',
  ...
  'picture-book': {
    ...
    structure: [
      ...
      'INVENT THE ARC: the shape of the story is yours to chart spread by spread. There is NO prescribed Scene A / Scene B / Scene C / Scene D. There is NO mandatory "home → journey → peak → heading home" template. Let the child, the theme, and the anecdotes dictate the shape. One story might stay at one specific place the whole time. Another might travel through several. What you owe the reader: a real beginning that hooks, a middle with tension and surprise, and a warm concrete resolution. Everything else is on you.',
      'OPENING LOCATION (HARD RULE): Spread 1 must be in a non-home, specific outdoor or public setting. "Waking up in bed", "at the kitchen table", "on the living-room rug", "in the playroom" are SHIP-BLOCKERS. Examples of acceptable openings: a splash pad, a park bench, the top of a slide, a tidepool, a meadow, a market stall, a bakery queue, a garden gate, the foot of a big tree. Pick something you could PHOTOGRAPH.',
