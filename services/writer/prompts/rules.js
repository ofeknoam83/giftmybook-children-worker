...
const RULES_BY_TIER = {
  ...
  'picture-book': {
    ...
    structure: [
      ...
      'INVENT THE ARC: the shape of the story is yours to chart spread by spread. There is NO mandatory "home → short outing → back home" template — that **anti-pattern** (most spreads indoors, 1-2 "away" in the middle, then home) reads as flat and overdone; prefer a **journey of several distinct, photographable settings** with clear transitions. You may use one sustained location when the theme truly demands it, but the default should be: interesting places, forward motion, and variety — not the same three rooms on repeat.',
      'OPENING LOCATION (HARD RULE): Spread 1 must be in a non-home, specific outdoor or public setting. "Waking up in bed", "at the kitchen table", "on the living-room rug", "in the playroom" are SHIP-BLOCKERS. Examples of acceptable openings: a splash pad, a park bench, the top of a slide, a tidepool, a meadow, a market stall, a bakery queue, a garden gate, the foot of a big tree. Pick something you could PHOTOGRAPH.',
