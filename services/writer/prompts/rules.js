...
const RULES_BY_TIER = {
  'young-picture': {
    ...
    structure: [
      ...
      'SEED-ARC SPINE (when a story seed provides a `fear`): Spread 1-3 plant the unease as a tiny undercurrent; spreads 5-9 dramatize it at its worst (one clear "worry moment"); spreads 10-13 RESOLVE it through a concrete action (gift given, hug received, shared moment) — never leave the fear unresolved.',
      ...
      'SETTING COHERENCE: Do NOT invent unusual compound-noun locations ("bath shop", "swim play spot", "hall rug seat") just to rhyme. Ordinary single-use places (meadow, stream, kitchen) are fine on a journey. If the characters change rooms or venues, narrate the transition in one line so the reader tracks where they are.',
    ],
    language: [
  ...
  'picture-book': {
    ...
    structure: [
      ...
      'SETTING COHERENCE: Do NOT invent unusual compound-noun locations ("bath shop", "swim play spot", "hall rug seat") just to rhyme. Ordinary single-use places (park, stream, kitchen) are fine on a journey. If the characters change rooms or venues, narrate the transition in one line so the reader tracks where they are.',
    ],
    language: [
