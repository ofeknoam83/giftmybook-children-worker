  ...
  if (isPictureBook) {
    ...
    if (isInfant) {
      ...
      lines.push(
        ...
        'High-risk repeating words to watch for: sun, sunshine, sunlight, light, warm, soft, glow, gleam, beam, peekaboo, hand, toes, smile, hold. If you used one in the previous spread, pick a different sensory anchor for this one.',
        '',
