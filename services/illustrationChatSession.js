...
function _buildCharacterEstablishmentPrompt(session) {
  ...
  parts.push('- Use a small-to-medium, neatly readable font size — clearly legible but compact, not dominating the illustration');
