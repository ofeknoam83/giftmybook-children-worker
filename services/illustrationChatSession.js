...
function _buildCharacterEstablishmentPrompt(session) {
  ...
  parts.push('- EDGE PADDING: Leave at least 8% from left and right, and 16% from top and bottom, so text is not cut when printed. Text must have visible breathing room from every edge.');
