...
function _buildCharacterEstablishmentPrompt(session) {
  ...
  parts.push('- Text must NEVER cross or touch the horizontal center of the image (the halfway line between top and bottom) — the ENTIRE text block must sit in the top half OR bottom half');
