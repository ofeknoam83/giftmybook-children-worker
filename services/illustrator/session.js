...
async function establishCharacterReference(session) {
  ...
  const parts = [
    {
      text: 'BOOK COVER — CHARACTER + STYLE GROUND TRUTH. This is the approved rendered likeness of the hero child in the target 3D Pixar art style. Use it as the canonical reference for the child (face, skin tone, hair, outfit) AND for any other person visible on the cover. Every spread you generate must match this character and this art style exactly.',
    },
    {
