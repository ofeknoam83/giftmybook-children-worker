...
function buildCharacterAnchorBlock(opts) {
  ...
  if (desc) {
    ...
    lines.push('- **REFERENCE IMAGES — what to match:** Reference 1 attached to this request is the BOOK COVER (canonical hero appearance + canonical art style). Any additional references are previously APPROVED interior spreads from this same book — they show the SAME hero you must render here. Match the hero face, hair, skin, and outfit to those references EXACTLY.');
