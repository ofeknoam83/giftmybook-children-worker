...
const PROMPT_TEMPLATE_VERSION = '1.4.0'; // 1.4.0: repair prompt fixes a missing companion/world proper name and a mangled versions echo (bounded, minimal-edit); 1.3.0: explicit per-spread literal anchors, derived from validation
