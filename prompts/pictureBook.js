...
function getThemeContext(theme) {
  switch (theme) {
    case 'birthday':
      return `\n\nTHEME CONTEXT — BIRTHDAY:\nThis is a birthday celebration story. The child is the birthday hero. The story should feel joyful, exciting, and special. Include: a birthday surprise or discovery, at least one moment of wonder or delight, a celebration element (cake/candles/balloons/friends/gifts — pick what feels natural). The story must NOT feel like a bedtime story — it should have energy and excitement from spread 1.\n\nBIRTHDAY ENDING OVERRIDE: The generic "Spread 12: Sleep / stillness" and "final lines must feel like a whisper" rules do NOT apply to this birthday story. Instead:\n- The child's specific age must be woven into the story. In at least 3 spreads, reflect what turning this age MEANS — something new they can do, a milestone, something they now understand that they didn't before. The age is the emotional spine, not just a candle count.\n- Spread 12 should be a held-breath moment — everyone gathers, lights dim, the room hushes. Give it a single quiet line that makes the reader hold their breath.\n- Spread 13 is the emotional climax: the birthday cake arrives, candles are lit, and the child blows them out. This is the moment the ENTIRE story has been building toward.\n- The ending should feel warm, joyful, and emotionally triumphant — not sleepy or whispered.\n- Every preceding spread should build anticipation for this final moment. The story arc is a journey TO the candles.`;
    case 'holiday':
